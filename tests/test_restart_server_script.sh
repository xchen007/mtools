...
grep -q 'DEFAULT_PYTHON_BIN="./.venv/bin/python"' "$SCRIPT_PATH"
grep -q 'resolve_python_bin()' "$SCRIPT_PATH"
grep -q 'command -v python3.11' "$SCRIPT_PATH"
grep -q 'PYTHONPATH="$ROOT_DIR/.venv/lib/python3.11/site-packages' "$SCRIPT_PATH"
